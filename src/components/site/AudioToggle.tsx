...
export default function AudioToggle() {
  ...
  return (
    <button
      ...
      data-hover
      className="audio-toggle group fixed bottom-6 right-6 z-[70] flex h-12 w-12 items-center justify-center rounded-full border border-white/15 bg-deep/70 backdrop-blur-xl transition-all hover:border-crab hover:bg-crab/10 pb-[max(1.5rem,env(safe-area-inset-bottom))] pr-[max(1.5rem,env(safe-area-inset-right))]"
    >
